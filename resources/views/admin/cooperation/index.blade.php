    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div
            ...
            <div class="flex items-center gap-3">
                {{-- button add --}}
                <div>
                    <a href="{{ route('cooperation.create') }}"
            ...
            <tbody>
                @foreach ($cooperations as $cooperation)
                    <tr
                        ...
                        <td>
                            <img class="w-20" src="{{ asset('storage/' . $cooperation->image) }}" alt="Gambar">
                        </td>
                        <td class="px-6 py-4">
                            <a href="{{ route('cooperation.edit', $cooperation->id) }}"
                            ...
                            <form class="inline" action="{{ route('cooperation.delete', $cooperation->id) }}"
                                method="post">
                                @csrf
                                @method('delete')
                                <button
