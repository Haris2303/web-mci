                ...
                @foreach ($devisions as $devisi)
                    <tr
                        ...
                        <th scope="row"
                            ...
                            <div class="ps-3">
                                <div class="text-base font-semibold">{{ $devisi->name }}</div>
                            </div>
                        </th>
                        <td class="px-6 py-4">
                            <a href="{{ route('devision.edit', $devisi->id) }}"
                            ...
                            <form action="{{ route('devision.delete', $devisi->id) }}" method="post">
                                @csrf
                                @method('delete')
                                <button
